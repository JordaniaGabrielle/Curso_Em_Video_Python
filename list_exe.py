...
# 6 - Crie um algotimo que leia um número e mostre o seu dobro, triplo e raiz quadrada.
...
# 11 - Faça um programa que leia a laregura e a altura de uma parede em metros
